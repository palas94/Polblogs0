	 ...
	 public static final String GRAPH = "graph";
	    ...
	    private void initDataGroups() throws FileNotFoundException {
	        ...
	        int b[][]=new int[19090][2];
	            ...
	            Scanner t = new Scanner(new File("/Users/Apple/Desktop/Polblogsedge.txt"));
	            ...
	            while (t.hasNextLine()) 
	            {
	            	...
	            	y++ ;
	            	if (k [first - 1] .equals (k [second - 1])) {
	            		if (k[first - 1].equals("0"))
	            		{
	            			lc++ ;
	            		}
	            		if (k[first - 1].equals("1"))
	            		{
	            			cc++ ;
	            		}
}
            		if (k[first -1].equals("0") && k[second -1].equals("1"))
            		{
            			i1c ++ ;
            		}
            		else if (k[first -1].equals("1") && k[second -1].equals("0"))
            		{
            			i2c ++ ;
	            	}
